                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group row">
                                <label for="username" class="col-sm-3 col-form-label col-form-label-sm">Nama</label>
                                <div class="col-sm-9">
                                    <input type="text" name="name" class="form-control form-control-sm @error('name') is-invalid @enderror" value="{{ old('name') }}" required autocomplete="name" autofocus placeholder="Enter your Name">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="form-group row">
                                <label for="image" class="col-sm-3 col-form-label col-form-label-sm">Foto Diri</label>
                                <div class="col-sm-9">
